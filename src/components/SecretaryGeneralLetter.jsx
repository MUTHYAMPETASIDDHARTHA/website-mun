    ...
    <section className="bg-white py-20 lg:py-32">
      <div className="max-w-4xl mx-auto px-6 lg:px-8">
        <div className="text-charcoal">
          ...
          <div className="max-w-none text-charcoal leading-relaxed">
            <p className="text-lg md:text-xl mb-8 font-sans font-normal leading-relaxed text-justify">
            ...
            <p className="text-base md:text-lg mb-8 font-sans font-normal leading-relaxed text-justify">
            ...
            <p className="text-base md:text-lg mb-12 font-sans font-normal leading-relaxed text-justify">
              Welcome to CMRCET Model United Nations 2026. Let the deliberations begin.
            </p>
            <div className="mt-16 pt-8 border-t border-gray-300">
              <p className="text-xl font-sans font-bold mb-2">Warm regards,
              <br />Akhil Chidugu</p>
...
export default SecretaryGeneralLetter
